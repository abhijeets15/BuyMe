	...
	<body>
		...
		<% 
			...
			if (keyword1 == "" && keyword2 == "") {
				...
				rs = st.executeQuery("SELECT * FROM faq WHERE question LIKE '%" + keyword1 + "%'");
			} else {
				rs = st.executeQuery("SELECT * FROM faq WHERE question LIKE '%" + keyword1 + "%' AND question LIKE '%" + keyword2 + "%'");
			}
		%>
		...
		<form method="post" action="FAQViewUser.jsp">
